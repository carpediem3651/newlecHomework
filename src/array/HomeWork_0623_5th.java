...
public class HomeWork_0623_5th {
	...
	public static void main(String[] args) throws IOException {
		...
		case 1: {
			...
			do {
				...
				if(!(0<=score[0] && score[0]<=100) || !(0<=score[1] && score[1]<=100) || !(0<=score[2] && score[2]<=100))
					System.out.println("성적의 범위(0~100)을 벗어났습니다.");
				
			}while(!(0<=score[0] && score[0]<=100) || !(0<=score[1] && score[1]<=100) || !(0<=score[2] && score[2]<=100));
